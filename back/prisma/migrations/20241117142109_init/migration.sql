...
CREATE TABLE "ProdutoUso" (
    ...
    "dt_fim" DATETIME,
    CONSTRAINT "ProdutoUso_id_movimentacao_fkey" FOREIGN KEY ("id_movimentacao") REFERENCES "Movimentacao" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "ProdutoUso_id_produto_fkey" FOREIGN KEY ("id_produto") REFERENCES "Produto" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
